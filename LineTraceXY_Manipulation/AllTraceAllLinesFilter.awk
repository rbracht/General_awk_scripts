BEGIN{
	...
	#********************************************************************
	#*****                                                          *****
        #***** This program will output all lines of a trace and        *****
        #***** all traces of a line that satisfies the conditions       *****
        #***** chosen by the user. In other words, if either the        *****
        #***** line or trace number satisfies user sepcified values     *****
	#***** will be passed. The criteria are:                        *****
	#*****                                                          *****
	...
	#*****                                                          *****
	#***** Therefore, all lines and traces conforming to one or     *****
	#***** the other of the following conditions will be retained:  *****
	#*****                                                          *****
...
# where the line and trace numbers actually reside.
#
  LineColumnNum  = 1
  TraceColumnNum = 2
